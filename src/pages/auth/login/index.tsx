  ...
  return (
    <div className="flex h-screen w-[vw]">
      ...
      <div className="flex-1 flex flex-col justify-center p-8">
        <div className="mb-6">
          <Text as="h1" variant="secondary" className="text-2xl font-bold mb-2">Welcome Back!</Text>
          <Text as="p" variant="secondary"  className="text-gray-600">Sign in to continue your journey</Text>
        </div>
        ...
        <form className="space-y-4" onSubmit={handleSubmit(handleLogin)}>
          ...
          />
          <Text as="p" variant="primary" className="text-right font-bold underline">
        ...
        <div className="flex p-1 justify-center m-2 gap-1.5">
          <Text as="p" variant="secondary">Don't have an account?</Text>
